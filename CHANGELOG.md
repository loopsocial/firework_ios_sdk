...
- Under certain circumstances, reapplying the `viewConfiguration` to the story block may lead to misconfigured settings.
- Trigger external ad tracking when video ads are not playing.
