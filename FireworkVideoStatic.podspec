Pod::Spec.new do |spec|
  spec.name                     = "FireworkVideoStatic"
  spec.version                  = "1.43.3-beta.6"
  spec.summary                  = "FireworkVideoSDK (static linkage)"
  ...
  spec.source                   = { :http => "https://github.com/loopsocial/firework_ios_sdk/releases/download/v#{spec.version}/FireworkVideo-v#{spec.version}-static.xcframework.zip" }
  ...
  # Force -ObjC on the host app target so Objective-C category symbols inside
  # the static archive are linked. Customers do not need to set this manually.
